...
import 'package:vantal/Admin/AdminScreens/AddVehicle.dart';
...
class VewVehicledetails extends StatelessWidget {
  String companyName;
  String vehicleName;
          ...
          children: [
            ...
            Consumer<MainProvider>(builder: (context, val, child) {
              return CarouselSlider(
                ...
                items: vehicleImages.map((String vImage) {
                  return Builder(
            ...
            Row(
              ...
              children: vehicleImages.map((String vImage) {
                int index = vehicleImages.indexOf(vImage);
                return Consumer<MainProvider>(builder: (context, val, child) {
                  return Container(
                    width: 8.0,
                    height: 8.0,
                    margin: EdgeInsets.symmetric(horizontal: 5.0),
